...
**Resume in one line (2026-09-18):** Site **live at https://fabosteo.fr** (GitHub Pages, repo
`Fabosteo77/fabosteo77.github.io`, custom domain + Let's Encrypt cert approved, HTTPS enforced; www → apex).
